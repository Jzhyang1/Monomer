...
public class IOType extends ObjectType {
    ...
    public IOType(){
        //io read
        List<Signature> readOptions = List.of(
        ...
        OverloadableType readFunction = new OverloadableType(readOptions);
        setField("read", readFunction);

        //io write
        List<Signature> writeOptions = List.of(
        ...
        OverloadableType writeFunction = new OverloadableType(writeOptions);
