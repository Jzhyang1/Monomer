...
The supported assignment operators are: *assign* (`a=b`), *increase* (`a+=b`), *decrease* (`a-=b`), *scale* (`a*=b`), *shrink* (`a/=b`), *increase* (`a+=b`),
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNzgzMjU4NzcsLTI0NjM0MDEwMCwtMj
