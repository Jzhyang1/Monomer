...
export default function StartPage() {
  return (
    <>
      ...
      <section>
        <SectionHead className="mt-[60px] mb-[30px]">
        ...
        <div className="m-[10px]">
          ...
          This will still display <Code colored={false}>Hello, World!</Code>,
          but it allows for more flexibility, as the constant{" "}
          <Code>message</Code> will likely be used more than this one time.{" "}
          <br />
          ...
          <List>
            ...
            <span>
              The keyword <Code>var</Code> in the assignment of <Code>x</Code>{" "}
              and <Code>y</Code> signals that they are variables
            </span>
            <span>
            ...
            <span>
              The <Code>if</Code>-<Code>else</Code> statement is tabbed over by
              a single tab (equivalent to 4 spaces) to signal that they fall
              under the <Code>for</Code> loop
            </span>
            <span>
        ...
        <div className="m-[10px]">
          ...
          The <Code>if</Code>-<Code>else</Code>-<Code>any</Code>-
          ...
          condition.
          <br />
          Constants declared in the condition of the while loop will be
          accessible in the condition and the body of the loop for every pass of
          the loop.
          <br />
          <Code blocked colored>
            for i in [0...10): <br />
          ...
          The for loop is the most commonly used loop. It can be used to repeat
          a block of code a fixed number of times, to use every value of an
          array, and to test every number of a range.
          <br />
          Constants declared in the condition of the for loop (before the{" "}
          <Code>in</Code> operator) will be accessible in the body of the loop
        ...
        <div className="m-[10px]">
          ...
          <br />
          Destructuring isn't necessary, but it makes this relatively easy to
          use.
        </div>
      </section>
    </>
